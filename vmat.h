...
{
    m[0] = vec4_set(1.f, 0.f, 0.f, 0.f);
    m[1] = vec4_set(0.f, 1.f, 0.f, 0.f);
    m[2] = vec4_set(0.f, 0.f, 1.f, 0.f);
    m[3] = vec4_set(0.f, 0.f, 0.f, 1.f);
}

static inline void mat4_rotate_x(float a, mat4 m)
{
    mat4 m0;

    m0[0] = vec4_set(1.f,    0.f,     0.f, 0.f);
    m0[1] = vec4_set(0.f, cos(a), -sin(a), 0.f);
    m0[2] = vec4_set(0.f, sin(a),  cos(a), 0.f);
    m0[3] = vec4_set(0.f,    0.f,     0.f, 1.f);
...
static inline void mat4_rotate_y(float a, mat4 m)
{
    mat4 m0;

    m0[0] = vec4_set( cos(a),    0.f, sin(a), 0.f);
    m0[1] = vec4_set(    0.f,    1.f,    0.f, 0.f);
    m0[2] = vec4_set(-sin(a),    0.f, cos(a), 0.f);
    m0[3] = vec4_set(    0.f,    0.f,    0.f, 1.f);
...
static inline void mat4_rotate_z(float a, mat4 m)
{
    ...
    m0[0] = vec4_set(cos(a), -sin(a), 0.f, 0.f);
    m0[1] = vec4_set(sin(a),  cos(a), 0.f, 0.f);
    m0[2] = vec4_set(   0.f,     0.f, 1.f, 0.f);
    m0[3] = vec4_set(   0.f,     0.f, 0.f, 1.f);

    mat4_mul(m, m0, m);
}

static inline void mat4_rotate(float a, float b, float c, mat4 m)
{
    mat4 m0, m1, m2, ms;
    mat4_identity(m0);
    mat4_identity(m1);
...
static inline void mat4_translate(vec4 v, mat4 m)
{
    mat4 m0;
...
static inline void mat4_scale(vec4 v, mat4 m)
{
    mat4 m0;

    m0[0] = vec4_set(v[0],  0.f,  0.f, 0.f);
    m0[1] = vec4_set( 0.f, v[1],  0.f, 0.f);
    m0[2] = vec4_set( 0.f,  0.f, v[2], 0.f);
    m0[3] = vec4_set( 0.f,  0.f,  0.f, 1.f);
